      ...
      <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-gray-500">or call directly</span>
          </div>
        </div>

        <a href="tel:+19179092257" className="w-full bg-white hover:bg-gray-50 text-primary border-2 border-primary px-4 py-2.5 rounded-lg font-semibold transition-all duration-200 text-sm sm:text-base flex items-center justify-center gap-2">
